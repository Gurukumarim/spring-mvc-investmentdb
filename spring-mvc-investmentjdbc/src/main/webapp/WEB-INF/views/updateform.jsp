...
<input type="hidden"  name="planId" value="${investment.planeId}" readonly><br>
Name<input type="text"  name="planName" value="${investment.planeName}" readonly><br>
...
Amount<input type="text" name="term" value="${investment.term}"readonly><br>
